...
def plot_cluster_top_terms(in_data, all_terms, nb_top_terms, model):
    ...
    for i, v in enumerate(range(number_of_subplots)):
        ...
        # print("xxxxxx:")
        # print(t[max_indices][::-1])
        ax1.set_title("Cluster %d (%d terms)" % (v, len(col_indices)), size=11)
        # print("yyyyyyy:")
        # print(tmp_terms[max_indices][::-1]) #en y
        print('Cocluster ',i,tmp_terms[max_indices][::-1])
...
def plotly_cluster_top_terms(in_data, all_terms, nb_top_terms, model):
    """Plot the top terms for each cluster.
    ...
    for i, v in enumerate(range(number_of_subplots)):
        ...
        # print("xxxxxx:")
        # print(t[max_indices][::-1])
        # print(len(t[max_indices][::-1]))
        # print(type(t[max_indices][::-1]))
        #ax1.set_title("Cluster %d (%d terms)" % (v, len(col_indices)), size=11)
        # print("yyyyyyy:")
        # print(tmp_terms[max_indices][::-1]) #en y
        # print(len(tmp_terms[max_indices][::-1]))
        # print(type(len(tmp_terms[max_indices][::-1])))
        fig.add_trace(go.Bar(
            y=tmp_terms[max_indices][::-1],
            x=t[max_indices][::-1],
            name='SF Zoo',
            orientation='h',
            marker=dict(
